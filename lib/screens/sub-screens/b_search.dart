  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      ...
      StreamBuilder<QuerySnapshot>(
          stream:  FirebaseFirestore.instance.collection('Hotel').where('District',isEqualTo: widget.name).snapshots(),
                ...
                child: Card(
                  ...
                  child: GestureDetector(
                    onTap: ()async{
                      ...
                      await Navigator.push(context, MaterialPageRoute(builder: (context)=>BDetails(image:img ,name: name, district: dis, desc: desc,img1: img1,img2: img2,img3: img3,)));
                    },
                    child: ListTile(
                        leading: Padding(
